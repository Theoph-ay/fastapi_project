...
from auth import CurrentUser, create_access_token, verify_password, hash_password
...
async def login_for_access_token(
    ...
    #verify user exists and pasword is correct
    #don't reveal which one failed (securoty best practice)
...
async def upload_profile_picture(
    ...
    if current_user.id != user_id:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Not authorized to upload picture for this user",
        )
